 ...
 * @author bhaumik
 */
public class SalesReturnView extends javax.swing.JInternalFrame {
    ...
    private void setPopUp() {
        ...
        ActionListener menuListener = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (row != -1 && column != -1) {
                    String ac_cd = jTable1.getValueAt(row, 12).toString();
            ...
            public void callPrint() {
                if (navLoad.getModel().getPRINTS().equalsIgnoreCase("1")) {
                    ...
                    if (row != -1) {
                        ...
                        pp.getSalesReturnBillPrint(jTable1.getValueAt(row, 0).toString());
                        pp.setVisible(true);
                    }
                } else {
                    lb.showMessageDailog("You don't have rights to perform this action");
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref no", "INV No", "Date", "Type", "Name", "Net Amt", "Cash", "Bank", "Card", "Bajaj", "SFID", "Remark", "Ac Cd", "Branch"
            }
        ) {
