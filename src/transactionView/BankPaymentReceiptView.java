 ...
 * @author bhaumik
 */
public class BankPaymentReceiptView extends javax.swing.JInternalFrame {
    ...
    public BankPaymentReceiptView(int type, int formCd) {
        initComponents();
    ...
    public void setData() {
        try {
            ...
            JsonObject call = bankAPI.GetBankPaymentHeader(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    lb.ConvertDateFormetForDB(jtxtToDate.getText()), vType + "", (jcmbBranch.getSelectedIndex() == 0) ? "0" : Constants.BRANCH.get(jcmbBranch.getSelectedIndex() - 1).getBranch_cd()
            ...
            if (call != null) {
                if (call.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(array.get(i).getAsJsonObject().get("OUR_BANK").getAsString());
...
//                        lb.showMessageDailog(response.body().getd("Cause").getAsString());
            ...
            Logger.getLogger(BankPaymentReceiptView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "", "Voucher", "Date", "Name", "Balance", "Remark", "Our Bank", "Cheque No", "AC Cd", "Branch Name"
            }
        ) {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            if (jTable1.getSelectedColumn() != -1 && jTable1.getSelectedColumn() != 0) {
                navLoad.callEdit();
            }
        }
