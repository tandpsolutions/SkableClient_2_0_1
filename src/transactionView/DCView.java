 ...
 * @author bhaumik
 */
public class DCView extends javax.swing.JInternalFrame {
    ...
    public DCView(int type, int formCD) {
        initComponents();
    ...
    private void setPopUp() {
        ...
        ActionListener menuListener = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (row != -1 && column != -1) {
                    String ac_cd = jTable1.getValueAt(row, 11).toString();
    ...
    public void setData() {
        try {
            ...
            JsonObject call = dcAPI.getDataHeader(lb.ConvertDateFormetForDB(jtxtFromDate.getText()), lb.ConvertDateFormetForDB(jtxtToDate.getText()),
                    vType + "",(jcmbBranch.getSelectedIndex() == 0) ? "0" : Constants.BRANCH.get(jcmbBranch.getSelectedIndex() - 1).getBranch_cd()
                    ,SkableHome.db_name,SkableHome.selected_year).execute().body();
            lb.removeGlassPane(this);
            if (call != null) {
                System.out.println(call.toString());
                PurchaseHead header = (PurchaseHead) new Gson().fromJson(call, PurchaseHead.class);
                if (header.getResult() == 1) {
                    ...
                    for (int i = 0; i < header.getPurchaseHeader().size(); i++) {
                        ...
                        row.add(header.getPurchaseHeader().get(i).getBILLNO());
                        row.add(header.getPurchaseHeader().get(i).getVTYPE());
                        row.add(header.getPurchaseHeader().get(i).getACNAME());
                        row.add(header.getPurchaseHeader().get(i).getITEMNAME());
                        row.add(header.getPurchaseHeader().get(i).getIMEINO());
                        row.add(header.getPurchaseHeader().get(i).getSERAILNO());
...
//                        lb.showMessageDailog(response.body().getd("Cause").getAsString());
            ...
            Logger.getLogger(DCView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    private void addPurchaseConroller() {
        DCController pc = new DCController(null, true, vType, this);
                            ...
                            try {
                                ...
                                if (call != null) {
                                    if (call.get("result").getAsInt() == 1) {
                                        lb.showMessageDailog("Voucher Delete Successfull");
                                        jButton1.doClick();
                                    }
                                }
                            } catch (IOException ex) {
                ...
                if (navLoad.getModel().getPRINTS().equalsIgnoreCase("1")) {
                    ...
                    if (vType == 0) {
                        if (row != -1) {
                            ...
                            lb.confirmDialog("Do you want to print it with amount?");
                            if (lb.type) {
                                pp.printDCVoucher(jTable1.getValueAt(row, 0).toString());
                            } else {
                                pp.printDCVoucherWithoutAmt(jTable1.getValueAt(row, 0).toString());
                            }
                            pp.setVisible(true);
                        }
                    } else {
...
//                                    System.out.println(response.body().toString());
                                        TagPrint tp = new TagPrint(response.body(), null);
                                        SkableHome.addOnScreen(tp, "Tag Print");
                                    }
                                }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jtxtFromDate, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref no", "INV No", "Date", "Bill No", "Type", "Name", "Item Name", "IMEI_NO", "SERIAL_NO", "Net Amt", "Remark", "Ac Cd", "Branch"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jpanelNav, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE))
