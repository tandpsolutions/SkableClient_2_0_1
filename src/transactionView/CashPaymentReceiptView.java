 ...
 * @author bhaumik
 */
public class CashPaymentReceiptView extends javax.swing.JInternalFrame {
    ...
    private CashPRAPI cashPRAPI;
    private int vType;

    public CashPaymentReceiptView(int type, int formCd) {
        initComponents();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Voucher", "Date", "Name", "Balance", "Remark", "AC Cd", "Branch"
            }
        ) {
