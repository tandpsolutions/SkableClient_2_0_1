 ...
 * @author bhaumik
 */
public class VisitorBookView extends javax.swing.JInternalFrame {
    ...
    private VisitorBookAPI visitorBookAPI;

    public VisitorBookView(int formCd) {
        initComponents();
        setUpData();
        visitorBookAPI = lb.getRetrofit().create(VisitorBookAPI.class);
    ...
    private void setPopUp() {
        ...
        ActionListener menuListener = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (row != -1 && column != -1) {
                    String ac_cd = jTable1.getValueAt(row, 4).toString();
    ...
    private void setData() {
        try {
            ...
            JsonObject call = visitorBookAPI.GetVisitorBookHeader(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    lb.ConvertDateFormetForDB(jtxtToDate.getText()), (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(),SkableHome.db_name,SkableHome.selected_year).execute().body();
...
//                        lb.showMessageDailog(response.body().getd("Cause").getAsString());
            ...
            Logger.getLogger(VisitorBookView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    private void addOrderController() {
        VisitorBookController pc = new VisitorBookController(null, true);
        pc.setLocationRelativeTo(null);
        pc.setData(visitorBookAPI, ref_no);
    }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Voucher", "Date", "Name", "Remark", "Mobile No", "Model Name", "Attended By"
            }
        ) {
