...
import transactionController.StockTransferOutsideController;
 ...
 * @author bhaumik
 */
public class StockTransferOutsideView extends javax.swing.JInternalFrame {
    ...
    public StockTransferOutsideView(int type, int formCd) {
        initComponents();
        setUpData();
        vType = type;
    ...
    public void setData() throws IOException {
        ...
        JsonObject call = stkTrAPI.getDataHeader(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                lb.ConvertDateFormetForDB(jtxtToDate.getText()), vType + "", (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(),SkableHome.db_name,SkableHome.selected_year).execute().body();
...
//                            lb.addGlassPane(StockTransferOutsideView.this);
