 ...
 * @author bhaumik
 */
public class StockAdjustmentView extends javax.swing.JInternalFrame {
    ...
    private StkAdjAPI stkAdjAPI;
    private int vType;

    public StockAdjustmentView(int type, int formCd) {
        initComponents();
        setUpData();
    ...
    public void setData() {
        try {
            ...
            JsonObject call = stkAdjAPI.getDataHeader(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    lb.ConvertDateFormetForDB(jtxtToDate.getText()), vType + "", (jcmbBranch.getSelectedIndex() == 0) ? "0" : jcmbBranch.getSelectedIndex() + "",SkableHome.db_name,SkableHome.selected_year).execute().body();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref no", "INV No", "Date", "Item Name", "Qty", "Code"
            }
        ) {
