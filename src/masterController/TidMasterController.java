...
public class TidMasterController extends javax.swing.JDialog {
    ...
    private void saveVoucher() {
        Call<JsonObject> call = tidApi.addUpdateTidMaster(tid_cd, jtxtTidNumber.getText(), SkableHome.user_id,SkableHome.selected_year,SkableHome.db_name,SkableHome.selected_year);
