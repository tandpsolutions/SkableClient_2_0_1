 ...
 * @author bhaumik
 */
public class SalesRegisterDetailAccount extends javax.swing.JInternalFrame {
    ...
    public SalesRegisterDetailAccount() {
        initComponents();
        registerShortKeys();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.SalesRegisterDetailAccount(jcmbPmt.getSelectedIndex(),
                    jcmbVtype.getSelectedIndex(),(jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd()
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(array.get(i).getAsJsonObject().get("buy_back_amt").getAsDouble());
                        row.add(array.get(i).getAsJsonObject().get("buy_back_model").getAsString());
                        row.add(array.get(i).getAsJsonObject().get("ins_amt").getAsDouble());
                    ...
                    lb.removeGlassPane(SalesRegisterDetailAccount.this);
                } else {
                    lb.removeGlassPane(SalesRegisterDetailAccount.this);
            ...
            Logger.getLogger(SalesRegisterDetailAccount.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void callExcel() {
        ...
        try {
            ...
            header.add("Debtor");
            header.add("Branch");
            lb.exportToExcel("Sales Register Detail", header, rows, "Sales Register Detail");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref_no", "Type", "Bill No", "Date", "Name", "Code", "Name", "IMEI", "Serail No", "Qty", "Rate", "Basic Item Amt", "Amt", "Basic Amt", "Tax", "Tax Amt", "Add tax Amt", "Net Amt", "Tax Name", "Cash", "Bank", "Card", "Buy Back Amt", "Buy Back Model", "Bajaj Amt", "Insurance Amt", "Debtors", "Branch"
            }
        ) {
        ...
        jcmbVtype.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcmbVtypeActionPerformed(evt);
            }
        });
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jLabel3, jLabel4, jbtnClose, jbtnExcel, jbtnView, jcmbPmt, jcmbVtype, jtxtFromDate, jtxtToDate});
    ...
    private void jcmbVtypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmbVtypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcmbVtypeActionPerformed
