 ...
 * @author LENOVO
 */
public class MarginReportSummary extends javax.swing.JInternalFrame {
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Date", "Rate", "Sale Rate", "Profit", "Branch"
            }
        ) {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel1, jRadioButton5, jcmbVtype, jtxtProductName});
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.MarginReportSummary(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    ...
                    , jCheckBox1.isSelected(), jCheckBox2.isSelected(),SkableHome.db_name,SkableHome.selected_year).execute().body();
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        pur_tot += lb.isNumber(jTable1.getValueAt(i, 2).toString());
                        sale_tot += lb.isNumber(jTable1.getValueAt(i, 3).toString());
                    ...
                    lb.removeGlassPane(MarginReportSummary.this);
                } else {
                    lb.removeGlassPane(MarginReportSummary.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
