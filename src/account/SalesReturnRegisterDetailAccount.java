 ...
 * @author bhaumik
 */
public class SalesReturnRegisterDetailAccount extends javax.swing.JInternalFrame {
    ...
    public SalesReturnRegisterDetailAccount() {
        initComponents();
        registerShortKeys();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.SalesReturnRegisterDetailAccount(jcmbPmt.getSelectedIndex(), (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(SalesReturnRegisterDetailAccount.this);
                } else {
                    lb.removeGlassPane(SalesReturnRegisterDetailAccount.this);
            ...
            Logger.getLogger(SalesReturnRegisterDetailAccount.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jLabel3, jLabel4, jbtnClose, jbtnExcel, jbtnView, jcmbPmt, jtxtFromDate, jtxtToDate});
