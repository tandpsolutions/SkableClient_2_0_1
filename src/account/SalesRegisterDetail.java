 ...
 * @author bhaumik
 */
public class SalesRegisterDetail extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    dtm.setRowCount(0);
                    dtm.setRowCount(0);
                    double basic_amt = 0.00, tax_amt = 0.00, add_tax_amt = 0.00, rate = 0.00, disc = 0.00, mrp = 0.00, amt = 0.00, net_amt = 0.00, buy_back_amt = 0.00, ins_amt = 0.00, bajaj = 0.00;
...
//                    dtm.addRow(row);
                    ...
                    lb.removeGlassPane(SalesRegisterDetail.this);
                } else {
                    lb.removeGlassPane(SalesRegisterDetail.this);
            ...
            Logger.getLogger(SalesRegisterDetail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            for (int i = 0; i < jTable1.getRowCount(); i++) {
            if (!jTable1.getValueAt(jTable1.getSelectedRow(), 2).toString().trim().equalsIgnoreCase("")) {
...
//            }
    ...
    private void initComponents() {
        ...
        jbtnExcel3.setText("Sent Mail");
        jbtnExcel3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnExcel3ActionPerformed(evt);
            }
        });
        jbtnExcel3.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jbtnExcel3KeyPressed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jbtnExcel3, javax.swing.GroupLayout.PREFERRED_SIZE, 87, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jbtnExcel3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExcel3ActionPerformed
        // TODO add your handling code here:
        sendSelesVoucher();
    }//GEN-LAST:event_jbtnExcel3ActionPerformed

    private void jbtnExcel3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jbtnExcel3KeyPressed
        // TODO add your handling code here:
