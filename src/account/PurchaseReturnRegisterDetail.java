 ...
 * @author bhaumik
 */
public class PurchaseReturnRegisterDetail extends javax.swing.JInternalFrame {
    ...
    public PurchaseReturnRegisterDetail() {
        initComponents();
        registerShortKeys();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.PurchaseReturnRegisterDetail(jComboBox1.getSelectedIndex(), jComboBox3.getSelectedIndex(),
...
//                    dtm.addRow(row);
                    ...
                    lb.removeGlassPane(PurchaseReturnRegisterDetail.this);
                } else {
                    lb.removeGlassPane(PurchaseReturnRegisterDetail.this);
            ...
            Logger.getLogger(PurchaseReturnRegisterDetail.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jComboBox1, jLabel3, jLabel4, jbtnClose, jbtnExcel, jtxtFromDate, jtxtToDate});
