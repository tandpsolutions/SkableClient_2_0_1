 ...
 * @author LENOVO
 */
public class AverageSalesReport extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    lb.removeGlassPane(AverageSalesReport.this);
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Brand Name", "Model Name", "PCS", "Sales", "Average", "Branch"
            }
        ) {
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.AverageSalesReport(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
