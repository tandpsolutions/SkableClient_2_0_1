 ...
 * @author LENOVO
 */
public class PhoneBook extends javax.swing.JInternalFrame {
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    public PhoneBook(String type, String fromDate, String toDate, String ac_cd, String ac_name, boolean checkFlag, int branch) {
        initComponents();
        registerShortKeys();
        searchOnTextFields();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void makeQuery() {
        ...
        try {
            ...
            JsonObject call = accountAPI.TypeWiseSalesDetail(((jcmbType.getSelectedIndex() > 0) ? typeList.get(jcmbType.getSelectedIndex() - 1).getTYPE_CD() : ""),
                    ...
                    jcmbVtype.getSelectedIndex(), ((jcmbType1.getSelectedIndex() > 0) ? typeList.get(jcmbType1.getSelectedIndex() - 1).getTYPE_CD() : ""), "", true, ""
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (i = 0; i < array.size(); i++) {
                        ...
                        if (!array.get(i).getAsJsonObject().get("address").isJsonNull()) {
                            row.add(array.get(i).getAsJsonObject().get("address").getAsString());
                        } else {
                            row.add("");
                        }
                    ...
                    lb.removeGlassPane(PhoneBook.this);
                } else {
                    lb.removeGlassPane(PhoneBook.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Mobile", "Email", "Address", "Date", "Item Name", "Branch"
            }
        ) {
        ...
        jcmbVtype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Retail", "Tax", "All" }));
