 ...
 * @author LENOVO
 */
public class ItemWisePSSales extends javax.swing.JInternalFrame {
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jtxtBillNo2 = new javax.swing.JTextField();
        ...
        jCheckBox3.setText("Show Report of Name, exclude not equal to name");
        ...
        jCheckBox5.setText("Bill Number");

        jtxtBillNo2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jtxtBillNo2FocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                jtxtBillNo2FocusLost(evt);
            }
        });
        jtxtBillNo2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jtxtBillNo2KeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jtxtBillNo2KeyTyped(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtxtModelName, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxtBrandName, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxtBillNo2, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jtxtBillNo2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jCheckBox5, jtxtBillNo2});
        ...
        try {
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(ItemWisePSSales.this);
                } else {
                    lb.removeGlassPane(ItemWisePSSales.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
            ...
            Logger.getLogger(ItemWisePSSales.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void jtxtBillNo2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtxtBillNo2FocusGained
        // TODO add your handling code here:
        lb.selectAll(evt);
    }//GEN-LAST:event_jtxtBillNo2FocusGained

    private void jtxtBillNo2FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtxtBillNo2FocusLost
        // TODO add your handling code here:
        lb.toInteger(evt);
    }//GEN-LAST:event_jtxtBillNo2FocusLost

    private void jtxtBillNo2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBillNo2KeyPressed
        // TODO add your handling code here:
        lb.enterFocus(evt, jbtnView);
    }//GEN-LAST:event_jtxtBillNo2KeyPressed

    private void jtxtBillNo2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtBillNo2KeyTyped
        // TODO add your handling code here:
        lb.onlyNumber(evt, -1);
    }//GEN-LAST:event_jtxtBillNo2KeyTyped
    ...
    private javax.swing.JTextField jtxtBillNo2;
