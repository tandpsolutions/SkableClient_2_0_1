 ...
 * @author bhaumik
 */
public class JournalVoucherRegister extends javax.swing.JInternalFrame {
    ...
    private void setPopUp() {
        ...
        ActionListener menuListener = new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (row != -1 && column != -1) {
                    String ac_cd = jTable1.getValueAt(row, 7).toString();
            ...
            if (call != null) {
                if (call.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add((array.get(i).getAsJsonObject().get("DRCR").getAsInt() == 1) ? "DR" : "CR");
...
//                        lb.showMessageDailog(response.body().getd("Cause").getAsString());
            ...
            Logger.getLogger(JournalVoucherView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    public void callExcel() {
        try {
            ...
            header.add("IMEI");
            header.add("REMARK");
            lb.exportToExcel("JV Register", header, rows, "DC Outward Register");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jButton1, jButton4, jbtnClose});
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Voucher", "Date", "Name", "Balance", "DR CR", "IMEI", "Remark", "AC CD"
            }
        ) {
