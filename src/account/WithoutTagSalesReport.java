 ...
 * @author LENOVO
 */
public class WithoutTagSalesReport extends javax.swing.JInternalFrame {
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    public WithoutTagSalesReport(String type, String fromDate, String toDate, String ac_cd, String ac_name, boolean checkFlag) {
        initComponents();
        registerShortKeys();
        searchOnTextFields();
        typeAPI = lb.getRetrofit().create(TypeAPI.class);
    ...
    private void getData(final String data) {
        try {
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    if (!data.equalsIgnoreCase("")) {
                        jcmbType.setSelectedItem(data);
                        jcmbType1.setSelectedItem(data);
                        jbtnView.doClick();
                    }
                } else {
            ...
            Logger.getLogger(WithoutTagSalesReport.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void makeQuery() {
        try {
            ...
            JsonObject call = accountAPI.WithoutTagSalesReport(((jcmbType.getSelectedIndex() > 0) ? typeList.get(jcmbType.getSelectedIndex() - 1).getTYPE_CD() : ""),
                    lb.ConvertDateFormetForDB(jtxtFromDate.getText()), lb.ConvertDateFormetForDB(jtxtToDate.getText()), ac_cd, sr_cd, brand_cd, model_cd,
                    ((jcmbType1.getSelectedIndex() > 0) ? typeList.get(jcmbType1.getSelectedIndex() - 1).getTYPE_CD() : ""),SkableHome.db_name,SkableHome.selected_year).execute().body();
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(WithoutTagSalesReport.this);
                } else {
                    lb.removeGlassPane(WithoutTagSalesReport.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Date", "Item Name", "PCS", "Amount", "IMEI NO", "REF"
            }
        ) {
