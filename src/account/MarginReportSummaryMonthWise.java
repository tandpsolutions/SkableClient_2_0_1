 ...
 * @author LENOVO
 */
public class MarginReportSummaryMonthWise extends javax.swing.JInternalFrame {
    ...
    public MarginReportSummaryMonthWise() {
        initComponents();
        registerShortKeys();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sr No", "Model Name", "Month", "Rate", "Sale Rate", "Profit", "Branch"
            }
        ) {
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.MarginReportMonthWiseSummary(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(MarginReportSummaryMonthWise.this);
                } else {
                    lb.removeGlassPane(MarginReportSummaryMonthWise.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
