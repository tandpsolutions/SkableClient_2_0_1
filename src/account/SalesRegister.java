...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.SalesRegister(jcmbPmt.getSelectedIndex(), jcmbVtype.getSelectedIndex(), (jcmbBranch.getSelectedIndex() == 0) ? "0" : Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    dtm.setRowCount(0);
                    double taxable = 0.00, tax = 0.00, add_tax = 0.00, net = 0.00, ins_amt = 0.00;
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(lb.Convert2DecFmtForRs(array.get(i).getAsJsonObject().get("ins_amt").getAsDouble()));
            ...
            Logger.getLogger(SalesRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void callExcel() {
        ...
        try {
            ...
            header.add("Net");
            header.add("Branch");
            lb.exportToExcel("Sales Register Summary", header, rows, "Sales Register Summary");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref_no", "Type", "Bill No", "Name", "Date", "Taxable Amt", "Tax Amt", "Add Tax Amt", "INS", "Net Amt", "Branch"
            }
        ) {
