 ...
 * @author LENOVO
 */
public class ItemWisePSWoRate extends javax.swing.JInternalFrame {
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SR No", "Name", "Date", "IMIE", "Item Name", "MRP"
            }
        ) {
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addComponent(jtxtBrandName, javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(jtxtModelName, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE))
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.IMEWisePS(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    lb.ConvertDateFormetForDB(jtxtToDate.getText()), model_cd, ac_cd, type_cd, brand_cd, "", sub_type_cd, "").execute().body();
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(ItemWisePSWoRate.this);
                } else {
                    lb.removeGlassPane(ItemWisePSWoRate.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
            ...
            Logger.getLogger(ItemWisePSWoRate.class.getName()).log(Level.SEVERE, null, ex);
        }
