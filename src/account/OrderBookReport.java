 ...
 * @author bhaumik
 */
public class OrderBookReport extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            if (call != null) {
                if (call.get("result").getAsInt() == 1) {
                    ...
                    double tot = 0.00;
                    for (int i = 0; i < array.size(); i++) {
                        tot += array.get(i).getAsJsonObject().get("BAL").getAsDouble();
                    }
