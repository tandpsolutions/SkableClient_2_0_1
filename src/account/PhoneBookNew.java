 ...
 * @author LENOVO
 */
public class PhoneBookNew extends javax.swing.JInternalFrame {
    ...
    public void getData() {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                lb.removeGlassPane(PhoneBookNew.this);
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    public void callExcel() {
        try {
            ...
            header.add("Email");
            header.add("Address");
            lb.exportToExcel("Phone Book", header, rows, "Phone Book");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(84, 84, 84)
                        .addComponent(jcmbHeadGroup, javax.swing.GroupLayout.PREFERRED_SIZE, 235, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jButton3, jButton4, jLabel3, jLabel4, jbtnView, jtxtFromDate, jtxtToDate});
