 ...
 * @author bhaumik
 */
public class PurchaseReturnRegister extends javax.swing.JInternalFrame {
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.PurchaseReturnRegister(jcmbPmt.getSelectedIndex(), (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(PurchaseReturnRegister.this);
                } else {
                    lb.removeGlassPane(PurchaseReturnRegister.this);
            ...
            Logger.getLogger(PurchaseReturnRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void callExcel() {
        ...
        try {
            ...
            header.add("Net");
            header.add("Branch");
            lb.exportToExcel("Purchase Return Register Summary", header, rows, "Sales Register Summary");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ref_no", "Bill No", "Name", "Date", "Taxable Amt", "Tax Amt", "Add Tax Amt", "Net Amt", "Branch"
            }
        ) {
