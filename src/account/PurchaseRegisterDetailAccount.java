 ...
 * @author bhaumik
 */
public class PurchaseRegisterDetailAccount extends javax.swing.JInternalFrame {
    ...
    public PurchaseRegisterDetailAccount() {
        initComponents();
        registerShortKeys();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.PurchaseRegisterDetailAccount(jcmbPmt.getSelectedIndex(),
                    jcmbType.getSelectedIndex(), (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd()
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(PurchaseRegisterDetailAccount.this);
                } else {
                    lb.removeGlassPane(PurchaseRegisterDetailAccount.this);
            ...
            Logger.getLogger(PurchaseRegisterDetailAccount.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void callExcel() {
        ...
        try {
            ...
            header.add("Debtor");
            header.add("Branch");
            lb.exportToExcel("Purchase Register Detail Account", header, rows, "Purchase Register Detail Account");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jcmbType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "RD Purchase", "URD Purchase", "All" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jcmbType, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jLabel3, jLabel4, jbtnClose, jbtnExcel, jbtnView, jcmbPmt, jcmbType, jtxtFromDate, jtxtToDate});
