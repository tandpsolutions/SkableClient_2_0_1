 ...
 * @author LENOVO
 */
public class DCRegister extends javax.swing.JInternalFrame {
    ...
    public DCRegister(String type, String fromDate, String toDate, String ac_cd, String ac_name, boolean checkFlag) {
        initComponents();
        registerShortKeys();
        searchOnTextFields();
        typeAPI = lb.getRetrofit().create(TypeAPI.class);
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    private void getData(final String data) {
        try {
            ...
            Logger.getLogger(DCRegister.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
        ...
        try {
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(DCRegister.this);
                } else {
                    lb.removeGlassPane(DCRegister.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
    ...
    public void callExcel() {
        try {
            ...
            header.add("REMARK");
            header.add("Bill");
            lb.exportToExcel("DC Outward Register", header, rows, "DC Outward Register");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Date", "Item Name", "PCS", "Amount", "IMEI NO", "Remark", "REF_NO", "Bill No"
            }
        ) {
        ...
        jRadioButton5.setText("DC Issue ");

        buttonGroup2.add(jRadioButton6);
        jRadioButton6.setText("DC Receipt");
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jBillDateBtn, jBillDateBtn1, jButton4, jLabel3, jLabel4, jLabel5, jbtnClose, jbtnView, jcmbType, jtxtFromDate, jtxtToDate});
