 ...
 * @author LENOVO
 */
public class TypeWiseSales extends javax.swing.JInternalFrame {
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        ...
                        amt += lb.isNumber2(jTable1.getValueAt(i, 3).toString());
                    }
                    ...
                    lb.removeGlassPane(TypeWiseSales.this);
                } else {
                    lb.removeGlassPane(TypeWiseSales.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
    ...
    public void callExcel() {
        try {
            ...
            header.add("Branch");
            lb.exportToExcel("Type Wise Sales", header, rows, "Type Wise Sales");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Type Name", "Model Name", "PCS", "Amount", "Branch"
            }
        ) {
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jcmbPmt1, javax.swing.GroupLayout.PREFERRED_SIZE, 309, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jcmbType, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
