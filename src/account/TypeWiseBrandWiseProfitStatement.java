 ...
 * @author LENOVO
 */
public class TypeWiseBrandWiseProfitStatement extends javax.swing.JInternalFrame {
    ...
    public TypeWiseBrandWiseProfitStatement() {
        initComponents();
        registerShortKeys();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void callExcel() {
        ...
        try {
            ...
            header.add("Profit");
            header.add("Branch");
            lb.exportToExcel("Type Wise Brand Wise Profit", header, rows, "Type Wise Brand Wise Profit");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Brand Name", "QTY", "Rate", "Sale Rate", "Profit", "Branch"
            }
        ) {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jbtnView1, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel7, jtxtBrandName});
        ...
        try {
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(TypeWiseBrandWiseProfitStatement.this);
                } else {
                    lb.removeGlassPane(TypeWiseBrandWiseProfitStatement.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
            ...
            Logger.getLogger(TypeWiseBrandWiseProfitStatement.class.getName()).log(Level.SEVERE, null, ex);
        }
