 ...
 * @author LENOVO
 */
public class MRPtoRateReport extends javax.swing.JInternalFrame {
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    public MRPtoRateReport(String type, String fromDate, String toDate, String ac_cd, String ac_name, boolean checkFlag, int branch) {
        initComponents();
        registerShortKeys();
        searchOnTextFields();
        setUpData();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void makeQuery() {
        try {
            ...
            JsonObject call = accountAPI.MrpToRateReport(((jcmbType.getSelectedIndex() > 0) ? typeList.get(jcmbType.getSelectedIndex() - 1).getTYPE_CD() : ""),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(lb.Convert2DecFmtForRs(array.get(i).getAsJsonObject().get("PER").getAsDouble()));
                        ...
                        row.add(array.get(i).getAsJsonObject().get("BILL_NO").getAsString());
                        dtm.addRow(row);
                    }
                    ...
                    for (int i = 0; i < jTable1.getRowCount(); i++) {
                        ...
                        sal += lb.isNumber2(jTable1.getValueAt(i, 6).toString());
                    }
                    ...
                    lb.removeGlassPane(MRPtoRateReport.this);
                } else {
                    lb.removeGlassPane(MRPtoRateReport.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
    ...
    public void callExcel() {
        try {
            ...
            header.add("branch");
            header.add("Bill No");
            lb.exportToExcel("Rate TO MRP", header, rows, "Rate To MRP");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Date", "Item Name", "PCS", "IMEI NO", "Rate", "MRP", "Per", "REF", "Branch", "Bill No"
            }
        ) {
        ...
        jCheckBox2.setText("Show only on hand stock");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", ">0", "<0", "=0" }));
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jComboBox1, jRadioButton1, jtxtProductName});
