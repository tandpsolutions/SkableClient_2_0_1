...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformedRoutine() {
        try {
            ...
            JsonObject call = accountAPI.SalesReturnRegisgerDetail(jComboBox1.getSelectedIndex(), Integer.parseInt(Constants.BRANCH.get(jComboBox3.getSelectedIndex()-1).getBranch_cd()),
