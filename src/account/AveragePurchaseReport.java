 ...
 * @author LENOVO
 */
public class AveragePurchaseReport extends javax.swing.JInternalFrame {
        ...
        try {
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    lb.removeGlassPane(AveragePurchaseReport.this);
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    public void callExcel() {
        try {
            ...
            header.add("PCS");
            header.add("Purchase Amount");
            header.add("Average Purchase Rate");
            header.add("Branch");
            lb.exportToExcel("Average Purchase Report", header, rows, "Average Sales Report");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Brand Name", "Model Name", "PCS", "Purchase", "Average", "Branch"
            }
        ) {
        ...
        jcmbVType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", "RD Purchase", "URD Purchase" }));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(jtxtAcName, javax.swing.GroupLayout.PREFERRED_SIZE, 210, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jlblMobile, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.AveragePurchaseReport(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
                    ...
                    (jcmbBranch.getSelectedIndex() == 0)?"0":Constants.BRANCH.get(jcmbBranch.getSelectedIndex()-1).getBranch_cd(), ac_cd,
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    for (int i = 0; i < array.size(); i++) {
                        ...
                        row.add(lb.Convert2DecFmtForRs(array.get(i).getAsJsonObject().get("PROFIT").getAsDouble()));
