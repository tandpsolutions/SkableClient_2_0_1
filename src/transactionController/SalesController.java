...
public class SalesController extends javax.swing.JDialog {
     ...
     */
    public SalesController(java.awt.Frame parent, boolean modal, int type, int formCD, SalesView sv) {
        super(parent, modal);
        initComponents();
        this.sv = sv;
...
//            double bank_charge = (lb.isNumber2(jtxtBankCharges.getText()));
    ...
    private void initComponents() {
        ...
        jcmbType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Retail Invoice", "Tax Invoice", "Retail Insurance Bill", "Retail Invoice ." }));
