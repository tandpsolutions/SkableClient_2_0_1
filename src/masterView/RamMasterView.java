...
import masterController.RamMasterController;
import model.RamMasterModel;
...
public class RamMasterView extends javax.swing.JInternalFrame {
    ...
    public RamMasterView(int formCD) {
        initComponents();
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    private void showDailogeAdd(String ram_cd, String ram_name) {
        RamMasterController rmc = new RamMasterController(null, true, this, ram_cd, ram_name);
        rmc.setLocationRelativeTo(null);
        rmc.setVisible(true);
    }

    public void addRow(String ram_cd, String ram_name) {
        ...
        if (selRow == -1) {
            ...
            jTable1.setValueAt(ram_cd, selRow, 0);
            jTable1.setValueAt(ram_name, selRow, 1);
        }
    }
        ...
        class navigation extends SmallNavigation {
            ...
            public void callEdit() {
                if (navLoad.getModel().getEDITS().equalsIgnoreCase("1")) {
                    ...
                    if (row != -1) {
                        navLoad.setMode("E");
                        lb.confirmDialog("Do you want to Edit This Ram?");
                        if (lb.type) {
                        ...
                        protected Object doInBackground() throws Exception {
                            ...
                            if (row != -1) {
                                try {
                                    ...
                                    lb.printToLogFile("Exception at callDelete at RamMasterView", ex);
                                } finally {
                                    lb.removeGlassPane(RamMasterView.this);
                                }
                            }
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                ...
                if (rspns.isSuccessful()) {
                    ...
                    if (result.get("result").getAsInt() == 1) {
                        TypeToken<List<RamMasterModel>> token = new TypeToken<List<RamMasterModel>>() {
                        };
                        ArrayList<RamMasterModel> detail = new Gson().fromJson(result.get("data"), token.getType());
                        dtm.setRowCount(0);
                        for (int i = 0; i < detail.size(); i++) {
                            Vector row = new Vector();
                            row.add(detail.get(i).getRAM_CD());
