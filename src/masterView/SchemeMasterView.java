...
import masterController.SchemeMasterController;
...
public class SchemeMasterView extends javax.swing.JInternalFrame {
    ...
    public SchemeMasterView(int formCD) {
        initComponents();
...
//    }
    ...
    private void showDailogeAdd(String scheme_cd, String scheme_name, int index) {
        SchemeMasterController bmc = new SchemeMasterController(null, true, this, scheme_cd, scheme_name, index);
        bmc.setLocationRelativeTo(null);
        bmc.show();
    }

    public void addRow(String scheme_cd, String scheme_name,int type_cd) {
        ...
        if (selRow == -1) {
            ...
            jTable1.setValueAt(scheme_cd, selRow, 0);
            jTable1.setValueAt(scheme_name, selRow, 1);
        }
    }
        ...
        class navigation extends SmallNavigation {
            ...
            public void callEdit() {
                if (navLoad.getModel().getEDITS().equalsIgnoreCase("1")) {
                    ...
                    if (row != -1) {
                        navLoad.setMode("E");
                        lb.confirmDialog("Do you want to Edit This Scheme?");
                        if (lb.type) {
                            showDailogeAdd(jTable1.getValueAt(row, 0).toString(), jTable1.getValueAt(row, 1).toString(), Integer.parseInt(jTable1.getValueAt(row, 2).toString()));
                        }
                    }
                } else {
                    lb.showMessageDailog("You don't have rights to perform this action");
                        ...
                        protected Object doInBackground() throws Exception {
                            ...
                            if (row != -1) {
                                try {
                                    ...
                                    lb.printToLogFile("Exception at callDelete at SchemeMasterView", ex);
                                } finally {
                                    lb.removeGlassPane(SchemeMasterView.this);
                                }
                            }
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                ...
                if (rspns.isSuccessful()) {
                    ...
                    if (result.get("result").getAsInt() == 1) {
                        ...
                        ArrayList<SchemeMasterModel> detail = new Gson().fromJson(result.get("data"), token.getType());
                        dtm.setRowCount(0);
