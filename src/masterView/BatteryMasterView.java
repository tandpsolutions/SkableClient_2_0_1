...
public class BatteryMasterView extends javax.swing.JInternalFrame {
    ...
    public BatteryMasterView(int formCD) {
        initComponents();
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    public void addRow(String battery_cd, String battery_name) {
        ...
        if (selRow == -1) {
            ...
            jTable1.setValueAt(battery_cd, selRow, 0);
            jTable1.setValueAt(battery_name, selRow, 1);
        }
    }
        ...
        class navigation extends SmallNavigation {
            ...
            public void callEdit() {
                if (navLoad.getModel().getEDITS().equalsIgnoreCase("1")) {
                    ...
                    if (row != -1) {
                        navLoad.setMode("E");
                        lb.confirmDialog("Do you want to Edit This Battery?");
                        if (lb.type) {
                        ...
                        protected Object doInBackground() throws Exception {
                            ...
                            if (row != -1) {
                                try {
                                    ...
                                    lb.printToLogFile("Exception at callDelete at BatteryaMasterView", ex);
                                } finally {
                                    lb.removeGlassPane(BatteryMasterView.this);
                                }
                            }
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                ...
                if (rspns.isSuccessful()) {
                    ...
                    if (result.get("result").getAsInt() == 1) {
                        TypeToken<List<BateryMasterModel>> token = new TypeToken<List<BateryMasterModel>>() {
                        };
                        ArrayList<BateryMasterModel> detail = new Gson().fromJson(result.get("data"), token.getType());
                        dtm.setRowCount(0);
                        for (int i = 0; i < detail.size(); i++) {
                            Vector row = new Vector();
                            row.add(detail.get(i).getBATTERY_CD());
