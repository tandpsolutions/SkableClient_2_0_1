...
//    }
    ...
    public void addRow(String model_cd, String model_name, String brand_name, String type_name, String tax_name, String hsn_code) {
        ...
        if (selRow == -1) {
            ...
            jTable1.setValueAt(hsn_code, selRow, 6);
        }
    }
