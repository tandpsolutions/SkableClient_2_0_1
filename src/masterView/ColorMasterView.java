...
public class ColorMasterView extends javax.swing.JInternalFrame {
    ...
    public ColorMasterView(int formCd) {
        initComponents();
...
//    }
    ...
    private void showDailogeAdd(String color_cd, String color_name) {
        ColorMasterController bmc = new ColorMasterController(null, true, this, color_cd, color_name);
                        ...
                        protected Object doInBackground() throws Exception {
                            ...
                            if (row != -1) {
                                try {
                                    ...
                                    lb.removeGlassPane(ColorMasterView.this);
                                }
                            }
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                ...
                if (rspns.isSuccessful()) {
                    ...
                    if (result.get("result").getAsInt() == 1) {
                        TypeToken<List<ColorMasterModel>> token = new TypeToken<List<ColorMasterModel>>() {
                        };
                        ArrayList<ColorMasterModel> detail = new Gson().fromJson(result.get("data"), token.getType());
                        dtm.setRowCount(0);
                        for (int i = 0; i < detail.size(); i++) {
                            Vector row = new Vector();
                            row.add(detail.get(i).getCOLOUR_CD());
