 ...
 * @author LENOVO
 */
public class MonthwiseModelWiseSalesStatement extends javax.swing.JInternalFrame {
    ...
    public MonthwiseModelWiseSalesStatement() {
        initComponents();
        registerShortKeys();
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
        try {
            ...
            JsonObject call = accountAPI.ModelWiseSalesStatement(lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
            ...
            if (call != null) {
                ...
                if (result.get("result").getAsInt() == 1) {
                    ...
                    lb.removeGlassPane(MonthwiseModelWiseSalesStatement.this);
                } else {
                    lb.removeGlassPane(MonthwiseModelWiseSalesStatement.this);
                    lb.showMessageDailog(call.get("Cause").getAsString());
                }
