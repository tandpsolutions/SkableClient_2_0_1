 ...
 * @author nice
 */
public class StockSummaryBalance extends javax.swing.JInternalFrame {
    ...
    public void getData() {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                lb.removeGlassPane(StockSummaryBalance.this);
...
//                    }
    ...
    private void jbtnExcelActionPerformedRoutine(final boolean email) {
        InventoryAPI inventoryAPI = lb.getRetrofit().create(InventoryAPI.class
        );
        if (jRadioButton3.isSelected()) {
            sr_cd = "";
...
//                    }
    ...
    public void callExcel() {
        try {
            ...
            header.add("Code");
            header.add("Brach");
            lb.exportToExcel("Stock Summary Balance", header, rows, "IMEI Statement");
        } catch (Exception ex) {
    ...
    public void callExcelEmail() {
        try {
            ...
            header.add("Code");
            header.add("Brach");
            lb.exportToExcelEmail("Stock Summary Balance", header, rows, "IMEI Statement");
        } catch (Exception ex) {
            lb.printToLogFile("Exception at callView as OPDPatientListDateWise", ex);
        }
    ...
    private void initComponents() {
        ...
        jbtnPreview2 = new javax.swing.JButton();
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Model Name", "Product Name", "Balance", "Product Code", "sr_cd", "Branch"
            }
        ) {
        ...
        jbtnPreview2.setText("Excel / Email");
        jbtnPreview2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnPreview2ActionPerformed(evt);
            }
        });
        jbtnPreview2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jbtnPreview2KeyPressed(evt);
            }
        });
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jbtnView, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jcmbBranch, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jbtnPreview1, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jbtnPreview2, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jbtnClose, jbtnPreview1, jbtnPreview2, jbtnView});

        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jCheckBox1, jcmbType, jtxtBrandName, jtxtModelName, jtxtProductName});

        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jCheckBox2, jLabel3});
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jbtnClose, jbtnView, jtxtProductName});
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2 && jTable1.getSelectedRow() != -1) {
            StockLedger sd = new StockLedger(jTable1.getValueAt(jTable1.getSelectedRow(), 1).toString(), jTable1.getValueAt(jTable1.getSelectedRow(), 4).toString());
            SkableHome.addOnScreen(sd, "item Ledger");
        }
    ...
    private void jbtnPreview1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPreview1ActionPerformed
        ...
        jPanel1.add(jScrollPane1);
        jScrollPane1.setVisible(true);
        jbtnExcelActionPerformedRoutine(false);
        lb.setColumnSizeForTable(jTable1, jPanel1.getWidth());
    ...
    private void jbtnPreview2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnPreview2ActionPerformed
        // TODO add your handling code here
        jPanel1.removeAll();
        jPanel1.add(jScrollPane1);
        jScrollPane1.setVisible(true);
        jbtnExcelActionPerformedRoutine(true);
        lb.setColumnSizeForTable(jTable1, jPanel1.getWidth());
    }//GEN-LAST:event_jbtnPreview2ActionPerformed

    private void jbtnPreview2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jbtnPreview2KeyPressed
        // TODO add your handling code here:
        lb.enterClick(evt);
    }//GEN-LAST:event_jbtnPreview2KeyPressed
    ...
    private javax.swing.JButton jbtnPreview2;
