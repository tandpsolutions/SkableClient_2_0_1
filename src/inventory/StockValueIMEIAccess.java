 ...
 * @author LENOVO
 */
public class StockValueIMEIAccess extends javax.swing.JInternalFrame {
    ...
    public void getData() {
        ...
        call.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
                lb.removeGlassPane(StockValueIMEIAccess.this);
...
//            lb.printToLogFile("Exception at dispose at codeBinding", ex);
    ...
    public void callExcel() {
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                row.add((jTable1.getValueAt(i, 6) == null) ? "" : jTable1.getValueAt(i, 6).toString());
                rows.add(row);
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SR", "Model Name", "Item Name", "IMEI", "Purchase Date", "Branch", "Scan IMEI"
            }
        ) {
...
//                            } else {
                            ...
                            if (jTable1.getValueAt(i, 3).toString().equalsIgnoreCase(cell.toString().toUpperCase().replaceAll("!", ""))) {
                                jTable1.setValueAt(cell.toString().toUpperCase().replaceAll("!", ""), i, 6);
                                check = true;
                                break;
                            }
//                        }
