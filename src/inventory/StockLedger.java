...
//    JasperReport report = null;
    ...
    public StockLedger(String prd_name, String fromDate, String toDate, String sr_cd) {
        initComponents();
        initOther();
        this.sr_cd = sr_cd;
    ...
    public StockLedger(String prd_name, String sr_cd) {
        initComponents();
        initOther();
        this.sr_cd = sr_cd;
        jtxtPrdName.setText(prd_name);
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
    ...
    public void callExcel() {
        try {
            ...
            header.add("TAG");
            header.add("Branch");
            lb.exportToExcel("Stock Ledger", header, rows, "Stock Ledger");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Voucher No", "Book", "Party Name", "Issue", "Reciept", "Balance", "TAG", "ref_no", "Branch"
            }
        ) {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "All", "PB", "SL", "SR", "PR", "STK", "STF" }));
...
private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
    ...
    Call<JsonObject> call = inventoryAPI.GetStockLedger(sr_cd, lb.ConvertDateFormetForDB(jtxtFromDate.getText()),
            lb.ConvertDateFormetForDB(jtxtToDate.getText()), ((jComboBox2.getSelectedIndex() > 0) ? Constants.BRANCH.get(jComboBox2.getSelectedIndex() - 1).getBranch_cd() : "0"), jComboBox1.getSelectedItem().toString());

    call.enqueue(new Callback<JsonObject>() {

        @Override
        public void onResponse(Call<JsonObject> call, Response<JsonObject> rspns) {
            lb.removeGlassPane(StockLedger.this);
