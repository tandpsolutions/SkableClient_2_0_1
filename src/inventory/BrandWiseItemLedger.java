 ...
 * @author nice
 */
public class BrandWiseItemLedger extends javax.swing.JInternalFrame {
...
//    JasperReport report = null;
     ...
     */
    public BrandWiseItemLedger() {
        initComponents();
        initOther();
    }

    public BrandWiseItemLedger(String prd_name, String fromDate, String toDate, String sr_cd) {
        initComponents();
        initOther();
        this.sr_cd = sr_cd;
...
//        add(new JScrollPane(jTable1), BorderLayout.CENTER);
        ...
        try {
            ...
            call.enqueue(new Callback<JsonObject>() {
                ...
                public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                    lb.removeGlassPane(BrandWiseItemLedger.this);
    ...
    public void callExcel() {
        try {
            ...
            header.add("Branch");
            header.add("Rate");
            lb.exportToExcel("Brand Wise Stock Ledger", header, rows, "Brand Wise Stock Ledger");
        } catch (Exception ex) {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Item Name", "Date", "Voucher No", "Book", "Party Name", "Issue", "Reciept", "TAG", "ref_no", "Branch", "Rate"
            }
        ) {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jbtnClose, jbtnPreview1, jbtnView});
