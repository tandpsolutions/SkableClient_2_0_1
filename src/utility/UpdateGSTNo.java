 ...
 * @author nice
 */
public class UpdateGSTNo extends javax.swing.JInternalFrame {
    ...
    public UpdateGSTNo(String tag_name) {
        initComponents();
        initOther();
...
private void jbtnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnViewActionPerformed
    try {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            ArrayList<AccountMasterModel> data = new ArrayList<>();
            for (int i = 0; i < sheetData.size(); i++) {
                final ArrayList row = (ArrayList) sheetData.get(i);
                final AccountMasterModel model = new AccountMasterModel();
                model.setAC_CD(row.get(0).toString());
                String gst_cd = "";
                gst_cd = (row.get(9).toString());
                model.setGST_NO(gst_cd.toUpperCase());
                data.add(model);
            }
