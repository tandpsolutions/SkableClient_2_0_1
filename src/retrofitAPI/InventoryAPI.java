...
public interface InventoryAPI {
    ...
    @GET("GetStockLedger")
    Call<JsonObject> GetStockLedger(@Query("sr_cd") String sr_cd, @Query("from_date") String type_name,
            @Query("to_date") String user_id, @Query("branch_cd") String branch_cd, @Query("doc_cd") String doc_cd,@Query("db_name") String db_name, @Query("db_year") String db_year);
    ...
    Call<JsonObject> GetBrandWiseStockLedger(@Query("sr_cd") String sr_cd, @Query("from_date") String type_name,
            @Query("to_date") String user_id, @Query("doc_cd") String doc_cd,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("TagTrackQty")
    Call<JsonObject> TagTrackQty(@Query("sr_cd") String sr_cd, @Query("from_date") String type_name, @Query("to_date") String user_id,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("GetTagTrack")
    Call<JsonObject> GetTagTrack(@Query("tag_no") String tag_no,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("IMEISearch")
    Call<JsonObject> IMEISearch(@Query("tag_no") String tag_no,@Query("db_name") String db_name, @Query("db_year") String db_year);
    ...
    Call<JsonObject> GetStockSummary(@Query("sr_cd") String sr_cd, @Query("type_cd") String type_cd, @Query("brnad_cd") String brnad_cd,
            ...
            @Query("branch_cd") String branch_cd, @Query("sub_type_cd") String sub_type_cd,@Query("db_name") String db_name, @Query("db_year") String db_year);
    ...
    Call<JsonObject> GetStockValueStatementDateWise(@Query("sr_cd") String sr_cd, @Query("type_cd") String type_cd, @Query("brnad_cd") String brnad_cd,
            @Query("model_cd") String model_cd, @Query("from_date") String from_date, @Query("to_date") String to_date, @Query("sub_type_cd") String sub_type_cd,@Query("db_name") String db_name, @Query("db_year") String db_year);
    ...
    Call<JsonObject> GetStockStatementDateWise(@Query("sr_cd") String sr_cd, @Query("type_cd") String type_cd, @Query("brnad_cd") String brnad_cd,
            @Query("model_cd") String model_cd, @Query("from_date") String from_date, @Query("to_date") String to_date, @Query("sub_type_cd") String sub_type_cd, @Query("including") int including,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("GetStockSummaryDetail")
    Call<JsonObject> GetStockSummaryDetail(@Query("sr_cd") String sr_cd,@Query("db_name") String db_name, @Query("db_year") String db_year);
    ...
    Call<JsonObject> getDataHeader(@Query("from_date") String from_date, @Query("to_date") String to_date,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("StockTrnasferUpdate")
    Call<JsonObject> StockTrnasferUpdate(@Query("ref_no") String ref_no, @Query("user_id") String user_id,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("GetStockInOutReport")
    Call<JsonObject> GetStockInOutReport(@Query("from_loc") String from_loc, @Query("from_date") String from_date, @Query("to_date") String to_date,@Query("db_name") String db_name, @Query("db_year") String db_year);

    @GET("TransferStockForReturn")
    Call<JsonObject> TransferStockForReturn(@Query("ac_year") String from_date, @Query("tag") String to_date,@Query("db_name") String db_name, @Query("db_year") String db_year);
}
